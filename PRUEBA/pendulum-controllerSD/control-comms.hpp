 ...
 * @author Shawn Hymel
 * @date 2023-08-05
 * @version 0.2 - Actualizado con comandos para control directo
 * 
 * @details
 ...
 *
 * ACTUALIZACIÓN v0.2:
 * - Agregados nuevos comandos para control directo sin swing-up
 * - CMD_START_DIRECT_CONTROL: Inicia control inmediato sin swing-up
 * - CMD_SET_SWING_MODE: Habilita/deshabilita el modo swing-up
 * - STATUS_DIRECT_CONTROL: Nuevo estado para control directo
 *
